...
class JsonTimeline2(File):
    ...
    def _analyze_json_data(self):
        ...
        if not self._hasYw7Ids:
            ...
            # Get a dictionary of yw7 IDs by title.
            self._get_yw7_ids()
